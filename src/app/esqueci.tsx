    ...
    <View style={styles.imagemBody}>
      <Image style={styles.imagemss}source={require('../../assets/sesi-senai.webp')}/>
        ...
        <View style={styles.form}>
            ...
            <Text style={styles.text}>Insira sua nova senha:</Text>

            <TextInput secureTextEntry placeholder="Insira sua senha" style={styles.input}/>

            <Text style={styles.text}>Repetir a senha:</Text>

            <TextInput secureTextEntry placeholder="Insira sua senha novamente" style={styles.input}/>
        </View>
